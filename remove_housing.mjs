...
console.log(`Aloitetaan suodatus RAM-ystävällisesti (Node.js ESM): ${inputFile}`);
...
out.on('finish', () => {
  ...
  console.log(`Tiedosto korvattu onnistuneesti! Voit poistaa skriptit tiedostot kun olet valmis.`);
});
